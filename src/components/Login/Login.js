...
const Login = () => {
    ...
    const login = async (e) => {
        ...
        setIsLoading(true);
        // API Call
        const response = await fetch('https://dark-jade-crocodile-gown.cyclic.app//api/auth/login', {
            method: 'POST',
            headers: {
            ...
            <form className="form__content" id="login-form" onSubmit={login}>
                ...
                <div className="form__div">
                    ...
                    <div className="form__div-input">
                        ...
                        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} name="password" className="form__input black" id="password"/>
                    </div>
                </div>
